# 2023 sujet 26 - ex1 - fd

#Programmer la fonction multiplication, prenant en paramètres deux nombres entiers n1 et n2,
...
def multiplication(n1, n2):
    ...
    '''
    produit=0
    # on se ramène d'abord au cas où n1 et n2 sont tous les deux positifs ou négatifs :
    if n1>=0:
        for _ in range(n1):
            produit=produit+n2
    else:
